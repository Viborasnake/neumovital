...
# Find where <!-- TARJETA DIAGNOSTICO --> starts and replace everything from there up to the end of the board-grid div.
# We look for the end of the grid which is just before <!-- LENGUAJE VISUAL / LINKS -->
html = re.sub(r'<!-- TARJETA DIAGNOSTICO -->.*?</div>\s*</div>\s*<!-- LENGUAJE VISUAL / LINKS -->', new_cards + '\n        </div>\n    </div>\n    \n    <!-- LENGUAJE VISUAL / LINKS -->', html, flags=re.DOTALL)
